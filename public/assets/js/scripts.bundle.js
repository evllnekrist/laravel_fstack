...
var KTLayoutQuickPanel = function() {
    ...
    var _statusRecapElement;
    var _notifKemendikbudElement;
    var _notifComplaintElement;
    var _notifMessagingElement;
    ...
    var _initStatusRecap = function() {
        KTUtil.scrollInit(_statusRecapElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _initNotifKemendikbud = function() {
        KTUtil.scrollInit(_notifKemendikbudElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _initNotifComplaint = function() {
        KTUtil.scrollInit(_notifComplaintElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _initNotifMessaging = function() {
        KTUtil.scrollInit(_notifMessagingElement, {
            mobileNativeScroll: true,
            resetHeightOnDestroy: true,
            handleWindowResize: true,
            height: function() {
    ...
    var _updateScrollbars = function() {
        $(_element).find('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            KTUtil.scrollUpdate(_statusRecapElement);
            KTUtil.scrollUpdate(_notifKemendikbudElement);
            KTUtil.scrollUpdate(_notifComplaintElement);
            KTUtil.scrollUpdate(_notifMessagingElement);
        });
    }
    ...
    return {
        init: function(id) {
            _element = KTUtil.getById(id);
            _statusRecapElement = KTUtil.getById('kt_quick_panel_status_recap');
            _notifKemendikbudElement = KTUtil.getById('kt_quick_panel_notif_kemendikbud');
            _notifComplaintElement = KTUtil.getById('kt_quick_panel_notif_complaint');
            _notifMessagingElement = KTUtil.getById('kt_quick_panel_notif_messaging');

            _init();
            _initStatusRecap();
            _initNotifKemendikbud();
            _initNotifComplaint();
            _initNotifMessaging();
